		...
		_create: function() {
			...
			var w = this,
				...
				d = o.useNewStyle === false ? {
					input: this.element,
					wrap: this.element.wrap('<div></div>').parent(), //change calendar:this.element.wrap('<div class="ui-input-datebox ui-shadow-inset ui-corner-all '+ (this.element.jqmData("mini") === true ? 'ui-mini ':'') +'ui-body-'+ thisTheme +'"></div>').parent(),
					mainWrap: $("<div>", { "class": 'ui-corner-all ui-datebox-hidden ' + trans + ' ui-body-' + thisTheme }).css('zIndex', o.zindex), //change calendar:mainWrap: $("<div>", { "class": 'ui-datebox-container ui-overlay-shadow ui-corner-all ui-datebox-hidden '+trans+' ui-body-'+thisTheme} ).css('zIndex', o.zindex),
					intHTML: false
				} : {
					input: this.element,
					wrap: this.element,
...
//				w.d.open = $('<a href="#"  title="'+this.__('tooltip')+'">'+this.__('tooltip')+'</a>')
